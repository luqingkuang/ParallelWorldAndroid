package com.dxns.parallelworld.view.fragment.commom;
...
import com.dxns.parallelworld.util.ViewUtil;
...
public abstract class BaseFragment extends Fragment {
    ...
    public final LoadingDialogFragment showLoadingDialog(String title) {
        LoadingDialogFragment ldf =  LoadingDialogUtils.show(getChildFragmentManager(), getClass().getSimpleName());
    ...
    public final LoadingDialogFragment setLoadingProgress(int progress){
        LoadingDialogFragment loadingDialogFragment = showLoadingDialog();
        loadingDialogFragment.setProgress(progress);
        return loadingDialogFragment;
    }
    public final LoadingDialogFragment setLoadingMax(int max){
        LoadingDialogFragment loadingDialogFragment = showLoadingDialog();
        loadingDialogFragment.setMax(max);
        return loadingDialogFragment;
    }
